...
PARSE_TOOL=/home/zhangli/caffe/tools/extra/parse_log.sh
DRAW_TOOL=/home/zhangli/caffe/tools/extra/plot_training_log.py.example
#LOG_FILE=./log/deepid2_55_47_dropout_1000000.log
LOG_FILE=/media/zhangli/program/DeepID-I-Reimplement-master/deepid1_144_144_1000000.log
SUFFIX=.log
BASENAME=$(basename -s $SUFFIX ${LOG_FILE})
CLEAN_FLAG=true

MODE=6
OUTPUT_FILE=/media/zhangli/program/DeepID-I-Reimplement-master/$BASENAME.png
